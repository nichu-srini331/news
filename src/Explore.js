...
function Explore() {
    ...
    const get = () => {
        fetch("https://newsdata.io/api/1/news?apikey=pub_13611920fc4e16de61d4303151117b14ba643&language=en&country=in").then((res)=>res.json()).then((j)=>setlatest(j.results))
       console.log(latest)
        }
    ...
    <div className='conatiner-fluid'>
      <div className='row'>
        ...
        <div className='col-10'>
          ...
          <div className='col-3'><h1 className='h1-trend'>Trending</h1>
        </div>
            <div className='col-9'>
